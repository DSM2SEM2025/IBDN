...
@router.get("/{perfil_id}", response_model=IbdnPerfil)
...
@router.put("/{perfil_id}", response_model=IbdnPerfil)
...
@router.post("/{perfil_id}/permissoes", response_model=IbdnPerfil, status_code=status.HTTP_201_CREATED)
...
@router.delete("/{perfil_id}/permissoes/{permissao_id}", response_model=IbdnPerfil)
