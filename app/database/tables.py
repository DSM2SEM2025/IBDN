...
def create_tables():
    ...
    try:
        ...
        tables['tipo_selo'] = "CREATE TABLE IF NOT EXISTS tipo_selo (id INT AUTO_INCREMENT PRIMARY KEY, nome VARCHAR(100) NOT NULL, descricao TEXT NOT NULL, sigla VARCHAR(10) NOT NULL UNIQUE, ativo BOOLEAN DEFAULT TRUE) ENGINE=InnoDB;"
